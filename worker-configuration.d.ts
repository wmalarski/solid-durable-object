/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f8d214873c0559f5221d3a1b674cbb82)
// Runtime types generated with workerd@1.20250525.0 2025-05-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BoardDurableObject: DurableObjectNamespace<import("./src/api/route").BoardDurableObject>;
		LobbyDurableObject: DurableObjectNamespace<import("./src/api/route").LobbyDurableObject>;
		ASSETS: Fetcher;
	}
}
